package com.springmaster.config;
...
protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
    ...
    for(SysRole role:userInfoService.queryRolesByUsername(userInfo.getUsername())){
        authorizationInfo.addRole(role.getRole());
        for(SysPermission p:userInfoService.queryPermissionByRole(role.getRole())){
...
protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token)
    ...
    SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(
            ...
            ByteSource.Util.bytes("master"),//salt=username+salt
            getName()  //realm name
    );
